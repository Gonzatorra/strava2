...
set JARPATH=%APP_HOME%\lib\strava-1.0-SNAPSHOT.jar

@rem Execute strava
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %STRAVA_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%STRAVA_EXIT_CONSOLE%" exit 1
exit /b 1
